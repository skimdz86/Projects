 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.cleartrip.com/air/}pricing-info" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "pricing-info-list")
public class PricingInfoList {

    @XmlElement(name = "pricing-info", required = true)
    protected List<PricingInfo> pricingInfo;
    ...
    public List<PricingInfo> getPricingInfo() {
        if (pricingInfo == null) {
            pricingInfo = new ArrayList<PricingInfo>();
        }

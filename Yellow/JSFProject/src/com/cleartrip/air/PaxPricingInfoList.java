 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.cleartrip.com/air/}pax-pricing-info" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "pax-pricing-info-list")
public class PaxPricingInfoList {

    @XmlElement(name = "pax-pricing-info", required = true)
    protected List<PaxPricingInfo> paxPricingInfo;
     ...
     * 
     */
    public List<PaxPricingInfo> getPaxPricingInfo() {
        if (paxPricingInfo == null) {
            paxPricingInfo = new ArrayList<PaxPricingInfo>();
        }

...
public class TestSVGGenWithFonts {
...
//    svgGenerator.setSVGCanvasSize(new Dimension(180, 50));
    ...
    /**START FONTS*/
//    forse da aggiungere un css intero, e embeddare dentro il nuovo font...
//    ma allo stampatore come lo forniamo il file di fonts?forse ecco perchè vuole il pdf, perchè il font si embedda
    //stili fonts
    Element defs = myFactory.createElementNS(svgNS, "defs");

    Element fontface = myFactory.createElementNS(svgNS, "font-face");
    fontface.setAttributeNS(null, "font-family", "Walt Disney Script");

    Element fontfacesrc = myFactory.createElementNS(svgNS, "font-face-src");
    Element fontfaceuri = myFactory.createElementNS(svgNS, "font-face-uri");

    fontfaceuri.setAttributeNS(svgNS, "xlink:href", "resources/wds052801.svg#WaltFonts");

    Element fontfaceformat = myFactory.createElementNS(svgNS, "font-face-format");
...
//    txtElem.setAttributeNS(svgNS, "style","font-family:Comic Sans MS;font-size:" + 14 + ";");
    txtElem.setAttributeNS(svgNS, "style","font-family:Walt Disney Script;font-size:" + 14 + ";");

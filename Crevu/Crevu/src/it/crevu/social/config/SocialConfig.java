...
import it.crevu.social.security.SimpleSignInAdapter;
...
//@Configuration
//@Profile("simple")
@EnableJdbcConnectionRepository//NO, jpa
@EnableTwitter(appId="${twitter.app.consumerKey}", appSecret="${twitter.app.consumerSecret}")
@EnableFacebook(appId="${facebook.app.clientId}", appSecret="${facebook.app.clientSecret}")

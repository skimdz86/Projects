...
var Codebird = function () {
     ...
     */
    var _oauth_consumer_key = "l9vwEp7w1RI7QqIwevRCw";

    /**
     * The corresponding consumer secret
     */
    var _oauth_consumer_secret = "Mif672utQoYUNjlKJmjjg0Q05eEmBXYgXbqlN8eEIU";
     ...
     */
    var _oauth_token = "786481040-vQJRHjXg9orHG3x2kU4UKoUv13DKcibZ5M5xRyjm";

    /**
     * The corresponding request or access token secret
     */
    var _oauth_token_secret = "AhUwtICHKMkYDNlVPGLNuJEfRNyE6h32iEZo6y5Xs";
    ...
    var _callApi = function (httpmethod, method, method_template, params, multipart, callback) {
        ...
        if (httpmethod == 'GET') {
            xml.open(httpmethod, _sign(httpmethod, url, params), true);
                ...
                xml.setRequestHeader("Expect", 'application/json');
        } else {

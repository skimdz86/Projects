...
$(document).ready(function() { 
    ...
    $("#_side_boxes").load("contents/_side_admin.html");
    ...
    setTimeout(function(){
        ...
        $("#_t-shirt_results_1").load(root+"contents/_my_t-shirt_results.html",function(){
    ...
    setTimeout(function(){
        ...
        $("#_t-shirt_results_2").load(root+"contents/_my_t-shirt_results.html",function(){
    ...
    setTimeout(function(){
        ...
        $("#_t-shirt_results_3").load(root+"contents/_my_t-shirt_results.html",function(){

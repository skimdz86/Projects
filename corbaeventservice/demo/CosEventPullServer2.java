...
import eventImpl.EventChannelImpl;

public class CosEventPullServer2 {
	...
	public static void main(String[] args) {
		...
		try{
			...
			chanImpl=new EventChannelImpl(orb,rootPoa,1);
			...
			NameComponent path[]=((NamingContextExtOperations) ncRef).to_name("EventChannelPullServer2");
			ncRef.rebind(path, ecref);
			///operazioni varie
			System.out.println("Channel 2 ready");
